...
VALUES (
    ...
    'Grill the chicken breast with the chosen seasonings at 200 Degree Celsius (392 Fahrenheit) for about 6-8 minutes per side or until the internal temperature reaches 165 Fahrenheit (74 Degree Celsius). Wash and pierce the sweet potato with a fork. Bake at 200 Degree Celsius (392 Fahrenheit) for around 45-60 minutes or microwave for about 5-7 minutes until tender. Trim the tough ends of the asparagus. Grill or steam the asparagus for about 4-5 minutes until tender but still crisp.',
...
VALUES (
    ...
    'Cut off the top of the bell pepper and remove seeds and membranes. Cook ground turkey in a skillet over medium heat until browned. Add diced tomatoes, onions, black beans, and desired seasonings. Stuff the bell pepper with the turkey, quinoa, and black bean mixture. Bake stuffed pepper at 175 Degree Celsius (350 Fahrenheit) for about 25-30 minutes until the pepper is tender.',
...
VALUES (
    ...
    '4 oz lean ground beef, 1/4 cup diced tomatoes, 1/4 cup sauteed onions, Whole wheat pasta',
    'Cook lean ground beef in a skillet over medium heat until browned. Add diced tomatoes and sauteed onions. Cook whole wheat pasta according to package instructions. Mix cooked pasta with beef marinara sauce.',
    '/images/recipes/BB_pasta.png'
);
...
VALUES (
    ...
    'Gordon Ramsay',
    'This breakfast masterpiece combines fluffy eggs with sauteed spinach and mushrooms, all generously folded around a gooey, melted cheese center. Its a protein-packed, veggie-infused delight that will have you eager to rise and shine each morning!',
    '3 eggs, 1 cup sauteed spinach, 1/2 cup sliced mushrooms, 1/4 cup shredded cheese (such as mozzarella or cheddar)',
    'Sauté sliced mushrooms until tender, then add fresh spinach and sauté until wilted. Beat three eggs in a bowl until well combined. Pour beaten eggs into a non-stick skillet over the sauteed vegetables. Cook until edges set, then sprinkle shredded cheese over half of the omelette. Fold the omelette in half, covering the cheese. Slide onto a plate and enjoy.',
...
VALUES (
    ...
    'Preheat the grill to medium-high heat. Rub the chicken breasts with olive oil and season with garlic powder, salt, and pepper. Grill the chicken for about 6-8 minutes per side, or until the internal temperature reaches 165 Fahrenheit (74 Degree Celsius). Let the chicken rest for a few minutes, then slice it. In a large bowl, combine the chopped romaine lettuce and sliced chicken. Add grated Parmesan cheese and drizzle with low-carb Caesar dressing. Toss to coat.',
...
VALUES (
    ...
    'Gordon Ramsay',
    'Grated cauliflower sauteed with a colorful mix of veggies, lean protein, and a savory blend of soy sauce and spices, all wok-tossed to perfection. Its a low-carb, high-flavor alternative that will satisfy your cravings for Asian-inspired comfort food without the guilt!',
...
VALUES (
    ...
    'In a bowl, mix together lemon zest, lemon juice, olive oil, minced garlic, dried herbs, salt, and pepper. Marinate chicken breasts in the lemon herb mixture for about 30 minutes. Preheat the grill to medium-high heat. Grill the chicken for about 6-8 minutes per side, or until the internal temperature reaches 165 Fahrenheit (74 Degree Celsius). Toss assorted vegetables with olive oil, salt, and pepper. Roast in the oven at 400 Fahrenheit (200 Degree Celsius) for about 20-25 minutes or until tender. Serve the grilled chicken with roasted vegetables. Garnish with chopped fresh parsley.',
...
VALUES (
    ...
    'Preheat the oven to 375 Fahrenheit (190 Degree Celsius). Cut the tops off bell peppers and remove seeds and membranes. In a bowl, mix cooked and flaked salmon, cooked quinoa, chopped spinach or baby kale, lemon juice, olive oil, salt, and pepper. Stuff the bell peppers with the salmon-quinoa mixture. Place the stuffed peppers in a baking dish. Bake in the preheated oven for about 20-25 minutes, until the peppers are tender. Garnish with fresh herbs before serving.',
...
VALUES (
    ...
    'Preheat your oven to 350 Fahrenheit (175 Degree Celsius). Place the salmon fillets on a baking sheet. Season them with salt, pepper, and chopped dill. Arrange lemon slices on top of each fillet. Bake for 15-20 minutes or until the salmon flakes easily with a fork. Serve with a side of steamed asparagus.',
